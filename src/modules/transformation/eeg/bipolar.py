...
Only EKG and the Bipolar map are left after applying this block.
"""
...
class BipolarEEG(VerboseTransformationBlock):
    """Convert the EEGs to bipolar configuration.
    This is done in place, so the original electrodes can not be accessed after this block.

    :param bipolar_map: The map to use for the bipolar conversion
    """
