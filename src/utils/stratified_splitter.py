...
class StratifiedSplitter:
    """Stratified splitter for creating stratified cross-validation splits."""

    n_splits: int = 5

    def split(self, X: pd.DataFrame, y: npt.NDArray[np.float32]) -> list[tuple[list[Any], list[Any]]]:  # type: ignore[type-arg]
